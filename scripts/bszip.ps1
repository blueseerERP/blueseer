...
compress-archive -update -path .patch -destinationpath blueseer.sqlite.deb.zip
...
compress-archive -update -path .patch -destinationpath blueseer.mysql.win.v42.zip
...
compress-archive -update -path .patch -destinationpath blueseer.mysql.linux.v42.zip
