...
mysql --defaults-extra-file=my.cnf %DB%  <panel_mstr.dat 
mysql --defaults-extra-file=my.cnf %DB%  <menu_mstr.dat
...
mysql --defaults-extra-file=my.cnf  -e "insert into car_mstr (car_code,car_type) values ('FEDX','carrier') ;" %DB% 
