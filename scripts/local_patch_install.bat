...
@echo "BlueSeer PATCH NOTE:  work around for group policy bs"
c:\NGCSof~1\sqlite\sqlite3.exe ..\..\data\bsdb.db <.patchsqliteV43
) else (
..\..\data\sqlite3.exe ..\..\data\bsdb.db <.patchsqliteV43
)
