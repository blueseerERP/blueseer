 ...
 * @author vaughnte
 */
public class ForecastBrowsePanel extends javax.swing.JPanel {
 
    DefaultTableModel mymodel = new DefaultTableModel();
    
    MyTableModel modeltrans = new ForecastBrowsePanel.MyTableModel(new Object[][]{},
